...
const ru: Messages = {
  ...
  'sftp.transfers.active': '{count} активных',
  'sftp.transfers.clearCompleted': 'Очистить завершённые',
  'sftp.transfers.calculatingTotal': 'Вычисление общего размера...',
  'sftp.transfers.filesCount': 'файлов',
  'sftp.transfers.filesProgress': '{current}/{total} файлов',
  ...
  'keychain.action.newIdentity': 'Новый ид',
  ...
  'keychain.count.items': '{count} записей',
